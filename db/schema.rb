...
ActiveRecord::Schema.define(version: 20190612184508) do
  ...
  create_table "refinery_taggings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["band_id_id"], name: "index_refinery_taggings_on_band_id_id"
    t.index ["event_id_id"], name: "index_refinery_taggings_on_event_id_id"
    t.index ["tag_id_id"], name: "index_refinery_taggings_on_tag_id_id"
  end
